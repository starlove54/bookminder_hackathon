...
export namespace $default {
  export interface Characters extends std.$Object {
    "description"?: string | null;
    "title": string;
  }
  export interface Stories extends std.$Object {
    "characters": Characters[];
    "storypoints": Storypoints[];
    "title": string;
  }
  export interface Storypoints extends std.$Object {
    "description"?: string | null;
    "title": string;
  }
  export interface Users extends std.$Object {
    "email": string;
    "fname"?: string | null;
    "img"?: string | null;
    "lname"?: string | null;
...
import Characters = $default.Characters;
import Stories = $default.Stories;
import Storypoints = $default.Storypoints;
import Users = $default.Users;
export type {
  Characters,
  Stories,
  Storypoints,
...
export interface types {
  ...
  "default": {
    ...
    "Storypoints": $default.Storypoints;
    "Users": $default.Users;
  };
  "fts": {
